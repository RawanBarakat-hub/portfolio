        ...
        gap-4 ">
            ...
            <div className="max-w-3xl">
                ...
                <p className="text-white text-xl mt-5">
                    I’m a <span className="text-primary-color font-bold">
                ...
                <p  className="text-white text-xl mt-5">I completed both my beginner
                    and advanced frontend training at <span className="text-primary-color font-bold"></span>Focal X,
                    where I built responsive websites using HTML, CSS, JavaScript, 
                    and <span className="text-primary-color font-bold">React</span>
                    (JSX and TSX), working on practical and academic projects.
                </p>
