        ...
        gap-4 ">
            ...
            <div className="max-w-3xl">
                ...
                <p className="text-white text-xl mt-5">
                    I’m a <span className="text-primary-color font-bold">Software Engineering and Information Systems</span>
                ...
                <p  className="text-white text-xl mt-5">I completed both my beginner
                    ...
                    and <span className="text-primary-color font-bold">React</span> (JSX and TSX), working on practical and academic projects.
                </p>
