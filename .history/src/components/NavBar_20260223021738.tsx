                ...
                <div className="hidden lg:block">
                    <ul className="flex gap-6">
                        {nav_links?.map((link,index)=>{
                            return <li key={index}>
                                <HashLink className="text-primary-color text-[18px] font-medium hover:text-hover-color" 
                ...
                <ul className="text-center">
                        {nav_links?.map((link,index)=>{
                            return <li key={index} className="mb-4">
                                <Hash className="text-primary-color text-[18px] font-medium" 
                                to={link?.url}>{link?.text}</Hash>
                            </li>
                        })}
                    </ul>
            </div>
