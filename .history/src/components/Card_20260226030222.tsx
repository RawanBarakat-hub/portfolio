...
const Card = ({image,title,text,code,deploy}:CardProps) => {
    return (
        <div className="w-100 h-auto rounded-lg overflow-hidden group">
            ...
            <div className="flex justify-between gap-2 bg-black p-3.5">
                <Icon url={deploy} image={{source:"/assets/images/icons/arrow.svg",
                alternative:"arrow icon"}} />
                <Icon url={code} image={{source:"/assets/images/icons/github.svg",
