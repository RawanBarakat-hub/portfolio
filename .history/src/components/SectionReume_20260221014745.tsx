        ...
        <section className="py-15 lg:py-8">
            ...
            <div className="flex justify-between">
                ...
                <div>
                    ...
                    <button className="p-3 rounded-md text-background-color bg-primary-color hover:bg-hover-color
                    text-[18px] font-medium mt-3 cursor-pointer">Download CV</button>
                </div>
            </div>
        </section>
    )
