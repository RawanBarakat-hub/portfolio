...
const Hero = () => {
    return (
        <div className="h-screen pt-55 lg:pt-25 px-9 flex flex-col lg:flex-row
        justify-center lg:justify-between items-center gap-5">
            <div className="text-center lg:text-left">
                ...
                <h1 className="text-white text-5xl mt-3 lg:mt-4
                lg:mb-6 font-bold">Rawan Mohammad Barakat</h1>
