...
const Hero = () => {
    return (
        <div className="h-screen pt-65 px-9">
            <div>
            ...
            <div className="w-3xs h-3xs border-2 border-primary-color
            shadow-sm shadow-primary-color">
                <img src="C:\focalx\my portfolio\public\assets\images\photos\rawan.jpg" alt="" />
            </div>
        </div>
    )
}
