...
const NavBar = ({logo,nav_links,bar_icon,cancel_icon}:NavProps) => {
    ...
    return (
        <div className="relative">
            <nav className="flex justify-between pl-5 pr-9 items-center fixed top-0 z-0
            w-full left-0 bg-background-color shadow-md shadow-primary-color">
                ...
                <button
                    ...
                    >
                    <img
                        src={show ? cancel_icon.source : bar_icon.source}
                        alt={show ? cancel_icon.alternative : bar_icon.alternative}
                    />
                </button>
            </nav>
            <div className={`
