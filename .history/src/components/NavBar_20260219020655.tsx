...
const NavBar = ({logo,nav_links,bar_icon,cancel_icon}:NavProps) => {
    return (
        <nav className="">
            ...
            <button className="hidden lg:block"><img src={bar_icon.source} alt={bar_icon.alternative} /></button>
            <button className="block lg:hidden"><img src={cancel_icon.source} alt={cancel_icon.alternative} /></button>
        </nav>
    )
}
